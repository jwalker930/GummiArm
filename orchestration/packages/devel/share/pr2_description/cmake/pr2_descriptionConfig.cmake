...
if("TRUE" STREQUAL "TRUE")
  set(pr2_description_SOURCE_PREFIX /home/joe/repos/GummiArm/orchestration/packages/src/pr2_common/pr2_description)
  set(pr2_description_DEVEL_PREFIX /home/joe/repos/GummiArm/orchestration/packages/devel)
  ...
  set(pr2_description_INSTALL_PREFIX /home/joe/repos/GummiArm/orchestration/packages/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joe/repos/GummiArm/orchestration/packages/src/pr2_common/pr2_description/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pr2_description_dep}_FOUND)
      find_package(${pr2_description_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pr2_description_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
