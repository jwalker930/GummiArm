...
if("FALSE" STREQUAL "TRUE")
  set(gummi_ikfast_right_plugin_SOURCE_PREFIX /home/joe/repos/GummiArm/orchestration/packages/src/gummi_ikfast_right_plugin)
  set(gummi_ikfast_right_plugin_DEVEL_PREFIX /home/joe/repos/GummiArm/orchestration/packages/devel)
  ...
  set(gummi_ikfast_right_plugin_INSTALL_PREFIX /home/joe/repos/GummiArm/orchestration/packages/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gummi_ikfast_right_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/joe/repos/GummiArm/orchestration/packages/install/${idir}'.  Ask the maintainer 'mstoelen <mstoelen@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${gummi_ikfast_right_plugin_dep}_FOUND)
      find_package(${gummi_ikfast_right_plugin_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gummi_ikfast_right_plugin_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
